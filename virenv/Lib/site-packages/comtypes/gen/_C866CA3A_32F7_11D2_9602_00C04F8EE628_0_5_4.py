...
__all__ = [
    ...
    'SGRSTTWildcard', 'SAFT32kHz16BitMono',
    'DISPID_SpeechWaveFormatEx', 'SVEAllEvents', 'ISpPhoneConverter',
    'DISPID_SRStatus', 'SVP_2', 'SVP_4', 'DISPID_SDKGetlongValue',
    'DISPID_SpeechRecognizer', 'SAFT8kHz16BitStereo', 'SREPrivate',
    'SVF_Stressed', 'DISPID_SVWaitUntilDone', 'ISpStream',
    'SAFT24kHz16BitMono', 'DISPID_SpeechRecoContext', 'SPEI_PHONEME',
    'DISPID_SLWLangId', 'DISPID_SOTCSetId', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SMSSetData', 'SPPS_Modifier', 'SpPhoneConverter',
    'SVSFPersistXML', 'SRERecognition', 'SPEVENTENUM',
    'DISPID_SRCERequestUI', 'DISPID_SPCIdToPhone', 'DISPID_SRGState',
    'SAFTADPCM_22kHzMono', 'Speech_StreamPos_RealTime',
    'SAFTCCITT_ALaw_8kHzMono', 'SpResourceManager',
    'DISPID_SpeechVoiceEvent', 'Speech_Max_Pron_Length',
    'DISPID_SRGetRecognizers', '_SPAUDIOSTATE', 'SPPS_RESERVED3',
    'DISPID_SGRAddState', 'DISPID_SPIAudioSizeTime', 'SRTSMLTimeout',
    'SAFT48kHz8BitMono', 'DISPID_SASNonBlockingIO',
    'SPAUDIOBUFFERINFO', 'SPVPRIORITY', 'SPEI_SR_PRIVATE',
    'SAFTNonStandardFormat', 'SPEI_PHRASE_START',
    'SSSPTRelativeToStart', 'ISpEventSink', 'SpeechDisplayAttributes',
    'SWPKnownWordPronounceable', 'SpeechRecoProfileProperties',
    'SAFTExtendedAudioFormat', 'ISpDataKey', 'SAFT12kHz16BitMono',
    'DISPID_SFSOpen', 'SVP_9', 'ISpStreamFormat',
    'eLEXTYPE_RESERVED9', 'SP_VISEME_9', 'SP_VISEME_2',
    'DISPID_SPRNumberOfElements', 'ISpGrammarBuilder', 'SVP_17',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SRSAudioStatus',
    'DISPID_SPPFirstElement', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SRRAlternates', 'DISPID_SVGetProfiles',
    'DISPID_SOTGetDescription', 'SpeechPropertyResourceUsage',
    'SPRULESTATE', 'SBOPause', 'SVP_11', 'SAFTADPCM_22kHzStereo',
    'SINone', 'DISPID_SpeechPhraseAlternates', 'DISPID_SRRTTickCount',
    'ISpNotifySource', 'SAFT32kHz8BitMono', 'SpInProcRecoContext',
    'DISPID_SOTId', 'ISpRecoCategory', 'DISPID_SAFGetWaveFormatEx',
    'SpMMAudioIn', 'SVEVoiceChange', 'SpObjectTokenCategory',
    'DISPID_SDKOpenKey', 'SDTDisplayText', 'SPINTERFERENCE_NOSIGNAL',
    'SGDSActiveWithAutoPause', 'DISPID_SVResume',
    'DISPID_SDKEnumValues', 'STSF_AppData',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SPPEngineConfidence',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SGRsAdd',
    'DISPID_SGRSTNextState', 'DISPID_SPPValue', 'SGRSTTWord',
    'eLEXTYPE_PRIVATE6', 'SP_VISEME_20', 'DISPID_SGRSTWeight',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpNullPhoneConverter', 'IEnumString', 'eLEXTYPE_PRIVATE14',
    'DISPID_SGRSAddRuleTransition', 'SAFT12kHz16BitStereo',
    'DISPID_SRCBookmark', 'IEnumSpObjectTokens',
    'SpeechCategoryPhoneConverters', 'DISPID_SPERetainedSizeBytes',
    'SPAR_Medium', 'DISPID_SRCEBookmark', 'eLEXTYPE_RESERVED10',
    'DISPID_SPRuleId', 'DISPID_SMSAMMHandle',
    'DISPID_SpeechRecoContextEvents', 'SAFTCCITT_ALaw_22kHzStereo',
    'ISpeechObjectToken', 'eLEXTYPE_PRIVATE4',
    'DISPID_SLRemovePronunciation', 'SRAExport', 'SVP_19',
    'ISpRecoGrammar', 'DISPID_SRCEEndStream', 'eLEXTYPE_PRIVATE18',
    'SFTInput', 'SAFT12kHz8BitStereo',
    'DISPID_SRSCurrentStreamNumber', 'SREFalseRecognition',
    'ISpNotifySink', 'SREAdaptation', 'DISPID_SRCRetainedAudio',
    'SVP_20', 'SPLO_STATIC', 'SP_VISEME_15', 'SFTSREngine',
    'SpeechEngineProperties', 'SPSHORTCUTPAIR', 'SVSFParseMask',
    ...
    'SpWaveFormatEx', 'DISPID_SRGDictationUnload',
    'eLEXTYPE_PRIVATE13', 'DISPID_SRRecognizer',
    'SAFTGSM610_22kHzMono', 'SVP_18', 'STSF_FlagCreate',
    'ISpeechMMSysAudio', 'SDTAudio', 'SPEI_START_SR_STREAM',
    'SRSActive', 'SRTReSent', 'DISPID_SpeechGrammarRuleState',
    'ISpeechPhraseAlternate', 'DISPID_SRRSpeakAudio',
    'ISpeechAudioBufferInfo', 'DISPID_SpeechVoiceStatus',
    'STSF_CommonAppData', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SpeechPhoneConverter', 'SPEI_RESERVED1',
    'SPSERIALIZEDRESULT', 'SAFTText', 'SAFT11kHz8BitMono', 'SPWORD',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SVSVisemeId',
    'SPEI_HYPOTHESIS', 'DISPID_SABufferInfo', 'DISPID_SAFGuid',
    'ISpRecoContext', 'ISpRecoResult', 'ISpeechPhraseAlternates',
    'SVP_3', 'DISPID_SPEs_NewEnum', 'SpSharedRecoContext',
    ...
    'DISPID_SRGetPropertyNumber', 'DISPID_SPRFirstElement',
    'DISPID_SPRuleParent', 'SP_VISEME_10', 'DISPID_SVSLastBookmark',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SPEsItem', 'SP_VISEME_7', 'SPEI_VOICE_CHANGE',
    'SpeechTokenShellFolder', 'SPDKL_LocalMachine',
    'SpInprocRecognizer', 'SPAR_Unknown', 'SPCT_SLEEP',
    'DISPID_SABIEventBias', 'DISPID_SOTSetId', 'SRARoot',
    'SAFTADPCM_8kHzStereo', 'DISPID_SpeechLexicon', 'SVP_10',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SPIEnginePrivateData',
    'SVSFUnusedFlags', 'SPEI_WORD_BOUNDARY', 'SPSVerb',
    'SRCS_Enabled', 'SPAO_RETAIN_AUDIO', 'SGSDisabled',
    'DISPID_SAVolume', 'SpCustomStream', 'DISPID_SpeechDataKey',
    'SPPS_Noun', 'ISpeechRecoResultDispatch',
    'DISPID_SOTIsUISupported', 'SPSUnknown', 'ISpRecoGrammar2',
    'eLEXTYPE_PRIVATE12', 'SPEI_SENTENCE_BOUNDARY',
    'SECFNoSpecialChars', 'SVSFDefault', 'DISPID_SGRClear',
    'DISPID_SOTMatchesAttributes', 'ISpeechBaseStream',
    'SPFM_OPEN_READWRITE', 'SAFT24kHz8BitMono',
    'DISPID_SPEDisplayAttributes', 'DISPID_SRCEPhraseStart',
    'DISPID_SFSClose', 'SPPS_Interjection',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SRRTStreamTime',
    'SPDKL_CurrentUser', 'SREStreamEnd', 'ISpNotifyTranslator',
    'ISpeechRecognizer', 'DISPID_SRCEFalseRecognition', 'SLOStatic',
    'DISPID_SDKGetStringValue', 'SAFT16kHz8BitMono',
    'SPRST_ACTIVE_ALWAYS', 'SPWF_INPUT',
    'SpeechPropertyResponseSpeed', 'SGSEnabled',
    'DISPID_SpeechLexiconWords', 'ISpAudio', 'SPSLMA',
    'DISPID_SRGRules', 'DISPID_SRRTLength', 'SPSModifier',
    'SpeechVoiceSpeakFlags', 'SPWT_PRONUNCIATION', 'SPCATEGORYTYPE',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SWFEBitsPerSample',
    'SDTProperty', 'SPPS_RESERVED1', 'SAFT24kHz16BitStereo',
    '_ISpeechVoiceEvents', 'DISPID_SLWPronunciations',
    'DISPID_SGRsCommit', 'SREAllEvents',
    'DISPID_SRGCmdLoadFromResource', 'SPAUDIOOPTIONS',
    'SPINTERFERENCE', 'DISPID_SGRSAddWordTransition',
    'SpeechPropertyNormalConfidenceThreshold',
    'SGDSActiveUserDelimited', 'SPVPRI_NORMAL', 'SPRST_NUM_STATES',
    'DISPID_SRProfile', 'SREAudioLevel', 'STCInprocServer', 'SASRun',
    'SPEI_TTS_PRIVATE', 'SPEI_MIN_TTS', 'SASStop',
    'eLEXTYPE_PRIVATE17', 'SAFTADPCM_8kHzMono', 'DISPID_SVSpeak',
    'DISPID_SVEWord', 'SPVPRI_ALERT', 'SRCS_Disabled',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRRAudio',
    'DISPID_SRCESoundEnd', 'SVSFPurgeBeforeSpeak',
    'DISPID_SABIMinNotification', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SpeechPhraseElements', 'SPSFunction', 'DISPID_SPRsItem',
    'DISPID_SGRsItem', 'STCLocalServer', 'SP_VISEME_8',
    'SREInterference', 'ISpeechRecoGrammar', 'DISPID_SRRPhraseInfo',
    'DISPID_SASState', 'SRERequestUI', 'SVSFParseSapi',
    'SPSERIALIZEDPHRASE', 'SpeechRegistryUserRoot', 'SDTRule',
    'DISPID_SpeechObjectTokenCategory', 'SAFT12kHz8BitMono',
    'DISPID_SOTCreateInstance', 'ISpPhoneticAlphabetConverter',
    'ISpeechPhraseRules', 'DISPID_SPRuleFirstElement',
    'DISPID_SPEActualConfidence', 'SAFT8kHz16BitMono',
    'SpeechRuleState', 'DISPID_SGRSTsCount', 'DISPID_SVEStreamStart',
    'DISPID_SVGetAudioOutputs', 'ISpeechRecoResult',
    'DISPID_SVSLastBookmarkId', 'SPPHRASEELEMENT', 'DISPIDSPRG',
    'eWORDTYPE_DELETED', 'SVEPrivate', 'SpeechRecognizerState',
    'SPWORDLIST', 'SPSHT_Unknown', 'SGSExclusive',
    'DISPID_SMSALineId', 'SAFT11kHz16BitStereo', 'DISPID_SLWType',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPCPhoneToId',
    'DISPID_SGRSTransitions', 'SpeechTokenContext', 'ISpRecognizer3',
    'DISPID_SVPause', 'DISPID_SRState', 'ISpLexicon',
    'DISPID_SPPChildren', 'SP_VISEME_19', 'ISpeechAudioStatus',
    'SRSEIsSpeaking', 'DISPID_SPILanguageId', 'SP_VISEME_3',
    'SGLexical', 'DISPID_SPIRule', 'SpeechCategoryAudioIn',
    'DISPID_SREmulateRecognition', 'SRTStandard',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPRECOSTATE',
    'DISPID_SVSInputSentenceLength', 'ISpeechPhraseProperties',
    'SPSNotOverriden', 'DISPID_SLGenerationId', 'SPEI_ADAPTATION',
    'SPPS_SuppressWord', 'tagSTATSTG',
    'DISPID_SRCCreateResultFromMemory', 'SVPNormal', 'SVSFVoiceMask',
    'eLEXTYPE_MORPHOLOGY', 'eLEXTYPE_RESERVED7', 'SGDSActive',
    'SPDATAKEYLOCATION', 'DISPID_SOTs_NewEnum',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRGDictationSetState',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SGRName',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SLPType',
    ...
    'ISpeechRecoContext', 'SPEI_RESERVED6', 'DISPID_SVVoice',
    'DISPID_SPAs_NewEnum', 'DISPID_SRCEPropertyStringChange',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SLGetPronunciations',
    'SpeechVoicePriority', 'SVEEndInputStream', 'DISPID_SRCState',
    'DISPID_SRRSetTextFeedback', 'DISPID_SVEBookmark',
    'SPPS_Noncontent', 'ISpRecognizer2', 'SPSNoun',
    'SAFT22kHz16BitMono', 'DISPID_SpeechPhraseRules',
    'ISpStreamFormatConverter', 'SPEI_SOUND_START',
    'DISPID_SPIGetDisplayAttributes', 'SpeechCategoryVoices',
    'SAFTDefault', 'DISPID_SOTDataKey', 'SAFT16kHz8BitStereo',
    'DISPIDSPTSI_SelectionLength', 'SGLexicalNoSpecialChars',
    'DISPID_SRCEventInterests', 'SVSFParseAutodetect',
    'DISPID_SPRulesItem', 'ISpeechLexiconPronunciation',
    'SP_VISEME_13', 'DISPID_SLWs_NewEnum', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPIDSPTSI', 'SpObjectToken', 'DISPID_SPEAudioSizeBytes',
    'SPPS_Unknown', 'SP_VISEME_14', 'SpeechAudioFormatType',
    'SPFM_CREATE_ALWAYS', 'DISPID_SLPsItem', 'DISPID_SGRInitialState',
    'SPEI_END_INPUT_STREAM', 'DISPID_SOTCategory', 'SVSFNLPMask',
    'SPLOADOPTIONS', 'SPBO_TIME_UNITS', 'SGRSTTRule',
    'DISPID_SVSInputWordLength', 'SpeechInterference',
    'DISPID_SPIStartTime', 'DISPID_SpeechAudio',
    'DISPID_SPELexicalForm', 'SPAS_RUN', 'SVSFIsFilename',
    'SRTAutopause', 'DISPID_SVEventInterests', 'ISpRecognizer',
    'DISPID_SLWWord', 'SAFTCCITT_uLaw_44kHzMono', 'SpShortcut',
    'SAFT22kHz8BitMono', 'ISpeechGrammarRuleState',
    'DISPID_SRSetPropertyNumber', 'LONG_PTR', 'SPXRO_SML', 'SPRULE',
    'ISpeechGrammarRules', 'DISPID_SVEEnginePrivate',
    'DISPID_SRCERecognizerStateChange', 'ISpeechPhraseInfo',
    'eLEXTYPE_PRIVATE7', 'SPBOOKMARKOPTIONS',
    'DISPID_SGRSAddSpecialTransition', 'SDKLCurrentUser',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPEI_RESERVED5', 'SPEI_RESERVED3', 'SVEStartInputStream',
    'DISPID_SGRId', 'DISPID_SRRSaveToMemory',
    'DISPID_SPEAudioSizeTime', 'DISPID_SPPsItem',
    'SAFTCCITT_uLaw_44kHzStereo', 'SITooQuiet', 'DISPID_SPAsCount',
    'SECLowConfidence', 'ISpeechPhoneConverter',
    'SpeechAudioProperties', 'SP_VISEME_1', 'DISPID_SPIReplacements',
    'DISPID_SGRSTRule', 'DISPID_SPRulesCount',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SpeechPropertyLowConfidenceThreshold', 'SRAInterpreter',
    'DISPID_SGRsDynamic', 'SPRS_INACTIVE', 'DISPID_SPARecoResult',
    'DISPID_SPEDisplayText', 'SPGS_EXCLUSIVE', 'ISpeechCustomStream',
    'SPEI_END_SR_STREAM', 'SpeechStreamFileMode',
    'ISpeechTextSelectionInformation', 'SPRECOCONTEXTSTATUS',
    'SAFT11kHz16BitMono', 'DISPID_SRGDictationLoad', 'SPVPRI_OVER',
    'SGRSTTDictation', 'DISPID_SRRTimes',
    'DISPID_SPERequiredConfidence', 'SpeechTokenKeyFiles',
    'ISpeechPhraseInfoBuilder', 'eLEXTYPE_PRIVATE20',
    'SPWORDPRONUNCIATIONLIST', 'eLEXTYPE_PRIVATE16',
    'ISpeechMemoryStream', 'SpeechTokenIdUserLexicon', 'ISpShortcut',
    'SRTEmulated', 'SPRECORESULTTIMES', 'SVSFNLPSpeakPunc',
    'DISPID_SPPName', 'SPPS_LMA', 'SAFT11kHz8BitStereo',
    'DISPID_SBSFormat', 'DISPID_SVEAudioLevel', 'SVP_1',
    'SpeechSpecialTransitionType', 'DISPID_SVSInputSentencePosition',
    'SGRSTTTextBuffer', 'SPSHT_NotOverriden',
    'DISPID_SRSCurrentStreamPosition', 'SPVISEMES',
    'eLEXTYPE_RESERVED4', 'SRSInactive', 'SPCS_DISABLED',
    'DISPID_SPAPhraseInfo', 'SpeechGrammarWordType', 'SpVoice',
    ...
    'ISpeechVoiceStatus', 'SpeechCategoryAudioOut',
    'ISpSerializeState', 'DISPID_SRRAudioFormat', 'SVEViseme',
    'SREStreamStart', 'SAFT16kHz16BitStereo', 'SECFDefault',
    'SVF_Emphasis', 'ISpeechLexiconWords',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpeechGrammarRule',
    'DISPID_SVGetVoices', 'DISPID_SVRate', 'DISPID_SGRSTsItem',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SVAudioOutputStream', 'WAVEFORMATEX',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SVP_12', 'SRESoundEnd',
    'DISPID_SpeechPhraseAlternate', 'SPCT_DICTATION', 'SLTUser',
    'SWTDeleted', 'DISPID_SOTCGetDataKey',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpUnCompressedLexicon',
    'SAFTCCITT_ALaw_11kHzMono', 'ISpeechRecognizerStatus',
    'DISPID_SAEventHandle', 'SpeechFormatType', 'DISPID_SOTsCount',
    'SPRECOGNIZERSTATUS', 'SDKLLocalMachine', 'DISPID_SWFEExtraData',
    'DISPID_SpeechPhraseReplacement', 'SpeechDictationTopicSpelling',
    'SpFileStream', 'SPSEMANTICFORMAT', 'SpeechGrammarTagDictation',
    'DISPID_SVEViseme', 'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SBSWrite',
    'DISPID_SpeechAudioFormat', 'DISPID_SASetState', 'ISpeechVoice',
    'STSF_LocalAppData', 'SDTReplacement', 'SpeechAudioVolume',
    'SECNormalConfidence', 'Speech_Default_Weight',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SpeechRecoResultTimes',
    'SVPOver', 'SREPropertyNumChange', 'SPTEXTSELECTIONINFO',
    'SpeechLoadOption', 'SPSHT_OTHER', 'SECFIgnoreWidth',
    'SPPHRASEREPLACEMENT', 'ISpeechObjectTokenCategory',
    'SECHighConfidence', 'DISPID_SPRsCount', 'SVSFlagsAsync',
    'DISPID_SPRuleChildren', 'SpeechGrammarRuleStateTransitionType',
    ...
    'SpeechRetainedAudioOptions', 'SpeechPartOfSpeech',
    'ISequentialStream', 'SPFM_NUM_MODES', 'SpeechWordType',
    'SP_VISEME_11', 'SAFT48kHz16BitMono', 'DISPID_SGRSTPropertyValue',
    'SPSTREAMFORMATTYPE', 'DISPID_SWFESamplesPerSec',
    'DISPID_SRCCreateGrammar', 'DISPID_SGRSTPropertyName',
    'DISPID_SVSkip', 'DISPID_SRRDiscardResultInfo',
    'SPEI_INTERFERENCE', 'SpeechVisemeFeature', 'DISPID_SPPId',
    'SAFTGSM610_44kHzMono', 'DISPID_SGRsCommitAndSave',
    'DISPID_SVAudioOutput', 'SPEI_PROPERTY_STRING_CHANGE', 'ISpVoice',
    'DISPID_SDKSetLongValue', 'DISPID_SCSBaseStream', 'SVP_7',
    'DISPID_SPACommit', 'SAFT8kHz8BitStereo', 'SECFIgnoreKanaType',
    'DISPID_SRIsUISupported', 'SPDKL_CurrentConfig',
    'DISPID_SLAddPronunciation', 'DISPID_SLGetGenerationChange',
    'SECFEmulateResult', 'ISpXMLRecoResult', 'SAFT44kHz16BitStereo',
    'SpeechGrammarState', 'DISPID_SRRRecoContext',
    'SpeechTokenValueCLSID', 'SWPUnknownWordPronounceable',
    'SSFMOpenReadWrite', 'DISPID_SpeechMemoryStream',
    'STCInprocHandler', 'DISPID_SVSCurrentStreamNumber',
    'SpeechVoiceEvents', 'DISPID_SPRs_NewEnum',
    'Speech_StreamPos_Asap', 'ISpeechGrammarRuleStateTransitions',
    'SRATopLevel', 'DISPID_SGRAddResource',
    'DISPID_SRSSupportedLanguages', 'eLEXTYPE_PRIVATE2',
    'SPSHORTCUTTYPE', 'SpeechMicTraining', 'SWTAdded',
    'SSTTTextBuffer', 'DISPID_SRAudioInputStream',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SPERetainedStreamOffset',
    'SRADynamic', 'SPWT_LEXICAL', 'DISPID_SpeechPhraseProperties',
    'SpeechAddRemoveWord', 'DISPID_SpeechBaseStream', 'SVSFParseSsml',
    'DISPID_SRGetFormat', 'SPLEXICONTYPE', 'SpeechUserTraining',
    'SPINTERFERENCE_TOOSLOW', 'SPBINARYGRAMMAR',
    'DISPID_SRSClsidEngine', 'DISPID_SRGIsPronounceable',
    'SSSPTRelativeToEnd', 'SBONone', 'SAFTADPCM_11kHzStereo',
    'SPSInterjection', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SVEPhoneme', 'SPEI_TTS_BOOKMARK', 'DISPID_SGRSTType',
    'DISPID_SVGetAudioInputs', 'SPBO_PAUSE',
    'DISPID_SRGCmdLoadFromFile', 'SPPS_RESERVED4', 'DISPID_SRCPause',
    'SpeechAudioFormatGUIDWave', 'DISPID_SBSRead',
    'SpeechLexiconType', 'SDTAll', 'DISPID_SRCreateRecoContext',
    'DISPID_SPCLangId', 'SRSActiveAlways', 'DISPID_SRGRecoContext',
    'SGDSInactive', 'eLEXTYPE_APP', 'SGRSTTEpsilon',
    'DISPID_SPPsCount', 'ISpeechObjectTokens', 'SDKLCurrentConfig',
    'DISPID_SRCSetAdaptationData', 'SITooFast', 'DISPID_SRGReset',
    'DISPID_SPPConfidence', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SpeechGrammarRule', 'ISpMMSysAudio', 'SpNotifyTranslator',
    'eLEXTYPE_PRIVATE8', 'DISPID_SRCESoundStart',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SPPNumberOfElements',
    'SRAORetainAudio', 'SPPROPERTYINFO', 'DISPID_SPRText',
    'DISPID_SLPs_NewEnum', 'DISPID_SRCEAudioLevel',
    'SPEI_START_INPUT_STREAM', 'DISPID_SpeechPhraseBuilder',
    'SPAUDIOSTATE', 'DISPID_SVAlertBoundary', 'SPSMF_UPS',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SVSPhonemeId',
    'DISPID_SpeechCustomStream', 'SRSEDone', 'DISPID_SOTGetAttribute',
    'DISPID_SpeechPhraseRule', 'DISPID_SpeechPhraseInfo', 'SPPHRASE',
    'SPAS_STOP', 'DISPID_SVESentenceBoundary',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SASClosed',
    ...
    'ISpeechAudio', 'DISPID_SRGCmdLoadFromObject', 'SP_VISEME_21',
    'SPRST_INACTIVE', 'DISPID_SOTGetStorageFileName', 'SREHypothesis',
    'ISpeechLexicon', 'DISPID_SPIProperties', 'DISPID_SVDisplayUI',
    'SDA_One_Trailing_Space', 'SP_VISEME_0', 'UINT_PTR',
    'SP_VISEME_4', 'SRSInactiveWithPurge', 'SP_VISEME_12',
    'SRESoundStart', 'SVEPhoneme', 'SAFTCCITT_uLaw_8kHzStereo',
    ...
    'SPLO_DYNAMIC', 'SAFT22kHz16BitStereo', 'SAFT44kHz8BitStereo',
    'SPBO_AHEAD', 'SVP_16', 'DISPID_SPRuleConfidence',
    'DISPID_SPIGrammarId', 'SAFT48kHz8BitStereo',
    'ISpeechGrammarRuleStateTransition', 'SpeechTokenKeyUI',
    'DISPID_SOTCDefault', 'DISPID_SpeechObjectToken',
    'SAFTCCITT_uLaw_22kHzStereo', 'ISpeechPhraseRule',
    'SPAUDIOSTATUS', 'DISPID_SLPsCount', 'SPWT_DISPLAY',
    'DISPID_SpeechAudioStatus', 'DISPID_SWFEFormatTag',
    'SVEWordBoundary', 'SPPS_NotOverriden',
    'SpeechGrammarTagUnlimitedDictation', 'SSFMOpenForRead',
    'SpeechRecoContextState', 'DISPID_SpeechVoice',
    'SPINTERFERENCE_TOOQUIET', 'SpStream', 'DISPID_SPPParent',
    'SLTApp', 'DISPID_SASCurrentDevicePosition',
    'SPWORDPRONUNCIATION', 'SRTExtendableParse', 'DISPID_SLWsCount',
    'SPPARTOFSPEECH', 'SPCT_SUB_COMMAND',
    'DISPID_SPEAudioStreamOffset', 'SVP_15', 'SAFTADPCM_11kHzMono',
    'ISpRecoContext2', 'SpeechEngineConfidence',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SpeechFileStream',
    'SREPropertyStringChange', 'SpeechGrammarTagWildcard', 'SVP_13',
    'SP_VISEME_17', 'SP_VISEME_5', 'ISpPhrase', 'SGDisplay',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SVVolume', 'SPGS_ENABLED',
    'SVP_5', 'DISPID_SRGSetWordSequenceData', 'SP_VISEME_18',
    'DISPID_SPEEngineConfidence', 'ISpeechResourceLoader',
    'SPPS_Function', 'tagSPTEXTSELECTIONINFO',
    'ISpeechPhraseReplacements', 'SpeechAllElements',
    'DISPID_SVPriority', 'SVF_None', 'ISpEventSource', 'SSFMCreate',
    'SAFT48kHz16BitStereo', 'SPVOICESTATUS',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPID_SOTRemove',
    'SAFT32kHz16BitStereo', 'DISPID_SGRs_NewEnum',
    'SPXMLRESULTOPTIONS', 'SVPAlert',
    'DISPID_SPAStartElementInResult', 'DISPID_SABIBufferSize',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SRCResume',
    'DISPID_SOTDisplayUI', 'SpeechVisemeType', 'STCRemoteServer',
    'SPEI_RECO_OTHER_CONTEXT',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SVIsUISupported',
    'DISPID_SLPSymbolic', 'SAFT16kHz16BitMono', 'SVP_6',
    'SpeechStreamSeekPositionType', 'DISPID_SWFEBlockAlign',
    'SpeechVoiceCategoryTTSRate', 'SAFT32kHz8BitStereo',
    'ISpeechRecoResultTimes', 'SpeechRunState',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRCERecognition',
    'SDA_Two_Trailing_Spaces', 'SpMMAudioOut',
    'DISPID_SPISaveToMemory', 'DISPID_SDKCreateKey',
    'DISPID_SVSpeakStream', 'SREPhraseStart', 'SVP_8',
    'SPGS_DISABLED', 'SSFMCreateForWrite',
    'SpeechCategoryAppLexicons', 'SVEBookmark', 'SVP_14',
    'SPWORDTYPE', 'SPEVENT', 'SpAudioFormat', 'SAFT44kHz16BitMono',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPADAPTATIONRELEVANCE',
    'DISPID_SpeechRecoResult', 'SINoSignal',
    'DISPID_SRCRetainedAudioFormat', 'eLEXTYPE_PRIVATE1',
    'SpeechAudioState', 'DISPID_SRDisplayUI', 'SRAONone',
    'DISPID_SRCEAdaptation', 'SPGRAMMARSTATE',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SPRuleName',
    'SPSHT_EMAIL', 'SPFM_OPEN_READONLY', 'SPEI_RECO_STATE_CHANGE',
    'SPPS_RESERVED2', 'ISpObjectWithToken', 'SECFIgnoreCase',
    'DISPID_SpeechPhraseReplacements', 'SPEVENTSOURCEINFO',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SGRsCount',
    'SpCompressedLexicon', 'SPFILEMODE',
    'DISPID_SpeechRecognizerStatus', 'SASPause',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SRCEHypothesis',
    'SPEI_UNDEFINED', 'SPFM_CREATE', 'DISPID_SOTCId',
    'SPSSuppressWord', 'ISpeechXMLRecoResult', 'SPRST_ACTIVE',
    'ISpeechWaveFormatEx', 'SPWF_SRENGINE', 'ISpeechRecoResult2',
    'ISpeechDataKey', 'SRERecoOtherContext', 'SAFT24kHz8BitStereo',
    'eWORDTYPE_ADDED', 'SAFTCCITT_uLaw_22kHzMono', 'SVP_21',
    'ISpeechFileStream', 'DISPID_SPAsItem', 'SPEI_MAX_SR',
    'SAFTNoAssignedFormat', 'eLEXTYPE_PRIVATE11',
    'DISPID_SRCRecognizer', 'DISPID_SADefaultFormat',
    'ISpeechAudioFormat', 'DISPID_SABufferNotifySize',
    'DISPID_SRCEInterference', 'SpTextSelectionInformation',
    'SSTTDictation', 'SpeechPropertyAdaptationOn',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SPIGetText',
    'SPCONTEXTSTATE', 'SpeechTokenKeyAttributes',
    'DISPID_SRRGetXMLErrorInfo', 'eLEXTYPE_RESERVED6', 'IStream',
    'DISPID_SRGCommit', 'SVEAudioLevel', 'SPDKL_DefaultLocation',
    'DISPID_SLPLangId', 'SITooLoud', 'SREStateChange', 'SPRS_ACTIVE',
    'DISPID_SpeechRecoResult2', 'SPEI_REQUEST_UI', 'DISPID_SOTsItem',
    'SDA_No_Trailing_Space', 'ISpResourceManager',
    'DISPID_SVSRunningState', 'SPAR_High', 'SDTPronunciation',
    'DISPID_SRRTOffsetFromStart', 'SpeechAudioFormatGUIDText',
    'DISPID_SAFSetWaveFormatEx', 'ISpPhoneticAlphabetSelection',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SRSetPropertyString',
    'DISPID_SRGId', 'DISPID_SPEsCount', 'SAFT22kHz8BitStereo',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SREBookmark',
    'SINoise', 'SVSFIsNotXML', 'SpSharedRecognizer',
    'DISPID_SPIElements', 'SPPS_Verb', 'ISpProperties',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SVSLastResult',
    'SAFT44kHz8BitMono', 'eLEXTYPE_USER', 'IInternetSecurityMgrSite',
    'ISpeechPhraseReplacement', 'DISPID_SWFEChannels', 'SP_VISEME_6',
    'SpeechWordPronounceable', 'eLEXTYPE_PRIVATE9', 'DISPID_SAStatus',
    'SPEI_FALSE_RECOGNITION', 'SPCT_SUB_DICTATION',
    'SDA_Consume_Leading_Spaces', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SMSGetData', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SMSADeviceId', 'SVSFIsXML', 'SpMemoryStream',
    'eLEXTYPE_PRIVATE19', 'SVESentenceBoundary',
    'DISPID_SRCRequestedUIType', 'DISPID_SPIRetainedSizeBytes',
    'ISpeechPhraseProperty', 'SPSEMANTICERRORINFO',
    'SpeechEmulationCompareFlags', 'DISPID_SGRsFindRule',
    'eLEXTYPE_RESERVED8', 'SpMMAudioEnum', 'SPXRO_Alternates_SML',
    'DISPID_SPRDisplayAttributes', 'STCAll',
    'SAFTCCITT_uLaw_11kHzStereo', 'ISpPhraseAlt',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SGRSTText',
    'SPINTERFERENCE_NOISE', 'SAFTGSM610_8kHzMono', 'SpeechRecoEvents',
    'SpLexicon', 'DISPID_SLAddPronunciationByPhoneIds',
    'SP_VISEME_16', 'SGPronounciation', 'SPCS_ENABLED',
    'SAFTGSM610_11kHzMono', 'SpPhoneticAlphabetConverter',
    'SPEI_SR_BOOKMARK', 'DISPID_SDKGetBinaryValue',
    'SPSHORTCUTPAIRLIST', 'DISPID_SDKDeleteKey', 'DISPID_SLWsItem',
    'IInternetSecurityManager', 'SAFTCCITT_uLaw_8kHzMono',
    'SPINTERFERENCE_NONE', 'DISPID_SRGSetTextSelection',
    'DISPID_SLGetWords', 'SLODynamic', 'SPWAVEFORMATTYPE',
    'SDKLDefaultLocation', 'DISPID_SRCVoice',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SpeechPhraseElement',
    '__MIDL_IWinTypes_0009', 'DISPID_SpeechMMSysAudio',
    'ISpObjectTokenCategory', 'SVP_0', 'SPBO_NONE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SpeechPropertyComplexResponseSpeed', 'SPEI_SOUND_END',
    'DISPID_SVStatus', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SPRules_NewEnum', 'SPEI_MAX_TTS', 'DISPID_SDKEnumKeys',
    'SRADefaultToActive', 'SPAS_PAUSE', 'SPEI_RECOGNITION',
    'ISpeechLexiconWord', 'SpeechDiscardType',
    'ISpeechPhraseElements', 'SDTAlternates',
    'eLEXTYPE_USER_SHORTCUT', 'Speech_Max_Word_Length', 'SPAO_NONE',
    '_ISpeechRecoContextEvents', 'SpPhraseInfoBuilder',
    'SPGRAMMARWORDTYPE', 'SDTLexicalForm', 'DISPID_SGRSTPropertyId',
    'DISPID_SGRAttributes', 'SITooSlow', 'SpeechBookmarkOptions',
    'SPEI_MIN_SR', 'SPPHRASERULE', 'SPAR_Low', 'eLEXTYPE_PRIVATE5',
    'DISPID_SPIEngineId', 'DISPID_SpeechLexiconPronunciation',
    'SpeechPropertyHighConfidenceThreshold', '_RemotableHandle',
    'DISPID_SGRSRule', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SpeechGrammarRules', 'eLEXTYPE_PRIVATE10', 'SPCT_COMMAND',
    'SPAS_CLOSED', 'DISPID_SRCEStartStream', 'DISPID_SAFType',
    'SSTTWildcard', 'DISPID_SpeechObjectTokens', 'SAFT8kHz8BitMono',
    'SPEI_VISEME'
]

_check_version('1.2.0', 1662606422.243110)
